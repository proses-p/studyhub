...
<html lang="en">
    <head>
      ...
      <title>Past papers - Diploma year 1</title>
    ...
    <body>
        <h2>Past papers - Diploma year 1</h2>
            ...
            <table>
                ...
                <?php while ($pp = mysqli_fetch_assoc($result)): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($pp['paper_title']) ?></td>
        ...
        <?php else: ?>
            <p><em>No past papers uploaded yet for diploma year 1.</em></p>
        <?php endif; ?>
    </body>
</html>